 ...
 *  
 */
package org.megastore.fulfilmentprocess.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception //NOPMD
	{
		...
		warehouseCounter.setName(MegastoreFulfilmentProcessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(MegastoreFulfilmentProcessConstants.PARENT_PROCESS);
