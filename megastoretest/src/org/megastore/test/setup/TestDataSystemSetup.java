 ...
 *  
 */
package org.megastore.test.setup;
...
import org.megastore.test.constants.MegastoreTestConstants;
import org.megastore.test.orders.AcceleratorTestOrderData;
 ...
 */
@SystemSetup(extension = MegastoreTestConstants.EXTENSIONNAME)
public class TestDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		if (getBooleanSystemSetupParameter(context, CREATE_TEST_DATA))
		{
			...
			importImpexFile(context, "/megastoretest/import/qa-test-users.impex");

			LOG.info("Creating Reviews...");
			importImpexFile(context, "/megastoretest/import/reviews.impex");
			...
			importImpexFile(context, "/megastoretest/import/cstickets.impex");
		}
	}
}
