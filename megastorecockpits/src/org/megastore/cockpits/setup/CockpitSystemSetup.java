 ...
 *  
 */
package org.megastore.cockpits.setup;
...
import org.megastore.cockpits.constants.MegastoreCockpitsConstants;
 ...
 */
@SystemSetup(extension = MegastoreCockpitsConstants.EXTENSIONNAME)
public class CockpitSystemSetup extends AbstractSystemSetup
{
	...
	public void createEssentialData(final SystemSetupContext context)
	{
		...
		{
			if (MediaManager.getInstance().getMediaFolderByQualifier(MegastoreCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER).size() < 1)
			{
				MediaManager.getInstance().createMediaFolder(MegastoreCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER,
						MegastoreCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER);
			}
			try
			{
				String prefix = null;
				...
				if (prefix != null){
					importImpexFile(context, "/megastorecockpits/reportcockpit/import/" + prefix + "_jasperreports.impex");
				}
			}
