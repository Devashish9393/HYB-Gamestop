 ...
 *  
 */
package org.megastore.core.hmc;
...
/**
 * Provides necessary meta information about the megastorecore hmc extension.
 * 
 * 
 * @version ExtGen v4.1
 */
public class MegastoreCoreHMCExtension extends HMCExtension
{
	/** Edit the local|project.properties to change logging behavior (properties log4j.*). */
	@SuppressWarnings("unused")
	private static final Logger LOG = Logger.getLogger(MegastoreCoreHMCExtension.class.getName());

	/** Path to the resource bundles. */
	public static final String RESOURCE_PATH = "org.megastore.core.hmc.locales";
