...
public class WebHttpSessionRequestCacheUnitTest
{
	...
	public void testCalcRedirectUrlWithEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/megastorestorefront/electronics/en",
						"https://electronics.local:9002/megastorestorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/megastorestorefront/electronics/en",
						"https://electronics.local:9002/megastorestorefront/electronics/en/"));
	...
	public void testCalcRedirectUrlWithMismatchEncodingAttrs()
	{
		assertEquals(
				"electronics/en",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/megastorestorefront/electronics/ja/Y/Z",
						"https://electronics.local:9002/megastorestorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/megastorestorefront/electronics/en",
						"https://electronics.local:9002/megastorestorefront/electronics/en/"));
	}
	...
	public void testCalcRedirectUrlWithoutEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/megastorestorefront",
						"https://electronics.local:9002/megastorestorefront"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/megastorestorefront",
						"https://electronics.local:9002/megastorestorefront/"));
	...
	public void testCalcRedirectUrlWithEncodingAttrsServletPath()
	{
		assertEquals(
				...
				executeCalculateRelativeRedirectUrl("electronics/en", "/megastorestorefront/electronics/en",
						"https://electronics.local:9002/megastorestorefront/electronics/en/Open-Catalogue/Cameras/Digital-Cameras/c/575"));
	}
